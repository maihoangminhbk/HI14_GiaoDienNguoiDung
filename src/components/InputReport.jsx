...
const InputReport = () => {
  ...
  const handleClick = () => {
    toast.success('Gửi báo cáo thành công!', { position: toast.POSITION.BOTTOM_RIGHT });
  }
    ...
    <div className=" md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      ...
      <div className="mt-5">
        ...
        <div className="group">
          ...
          {/* <input type="textarea" rows="4" className="input"/><p/> */}
          <textarea className='input' name="w3review" rows="4"></textarea>
        </div>
